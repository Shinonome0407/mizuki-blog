...
export const siteConfig: SiteConfig = {
	...
	bangumi: {
		userId: "628509", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/0c05706c7444a4460bce099476dfd5c3.jpg",// 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "東雲佑樹",
	bio: "你要了解哪个层面的我?",
	typewriter: {
